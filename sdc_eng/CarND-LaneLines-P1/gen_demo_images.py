...
def detect_lane_lines(image):
    ...
    #plt.imsave("assets/grayscale.jpg", gray, cmap = "gray")
    gray_blur = gaussian_blur(gray, kernel_size = 5)

    #plt.imsave("assets/gaussian_blur.jpg", gray_blur, cmap = "gray")

    edges = canny(gray_blur, low_threshold = 50, high_threshold = 150)

    #plt.imsave("assets/canny.jpg", edges, cmap = "gray")
    #sys.exit()
...
if __name__ == "__main__":
    ...
    detect_lane_lines(mpimg.imread("test_images/solidWhiteRight.jpg"))
